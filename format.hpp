...
namespace lib
{
  ...
  template <size_t n>
  size_t length_of(const char (&s)[n])
  {
    return n - 1;
  }
  ...
  template <size_t n>
  size_t length_of(const wchar_t (&s)[n])
  {
    return n - 1;
  }
  ...
  template <character char_t>
  size_t length_of(const char_t &c)
  {
    return 1;
  }
  ...
  unsigned length_of(const integral_t &i)
  {
  ...
  template <character char_t>
  size_t length_of(const basic_string<char_t> &s)
  {
  ...
  template <character char_t>
  size_t length_of(const vector<char_t> &v)
  {
